...
async def stage1_collect_responses(user_query: str) -> List[Dict[str, Any]]:
    ...
    Args: user_query: The user's question
    ...
    responses = await query_models_parallel(COUNCIL_MODELS, message)
...
async def stage2_collect_rankings(
    ...
    Args: user_query: The original user query
...
async def stage3_synthesize_final(
    ...
    message = [{"role": "user", "content": chairman_prompt}]

    # Query the chairman model
    response = await query_model(CHAIRMAN_MODEL, message)
...
def parse_ranking_from_text(ranking_text: str) -> List[str]:
    ...
    Args: ranking_text: The full text response from the model
...
def calculate_aggregate_rankings(
    ...
    Args: stage2_results: Rankings from each model
...
async def generate_conversation_title(user_query: str) -> str:
    ...
    Args: user_query: The first user message
    ...
    response = await query_model("google/gemini-2.5-flash", message, timeout=30.0)
